...
def add_event_view():
    ...
    with st.form("add_event_form"):
        ...
        with col_num_1:
            st.number_input("Expected Attendees", min_value=1, value=0, step=1, key="event-attendees")
        with col_num_2:
            st.number_input("Budget (PESO)", min_value=0.0, value=0.00, step=0.01, format="%.2f", key="event-budget")
